...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCRelativeTimer-4.1.0-rc.8.xcframework.zip",
			checksum: "4718418647664bfdd45a89839780b5c51a0e4080b566d71f383a59cf29b36931"
		)
	]
)