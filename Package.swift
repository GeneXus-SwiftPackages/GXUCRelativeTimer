...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.5.0-beta.3.xcframework.zip",
			checksum: "3e1e1bb874683321ed44b90ebf0dfc5e8fa83f01815acdfe028eba5e8f60ceba"
		)
	]
)