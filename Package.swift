...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-4.2.0-beta.23.xcframework.zip",
			checksum: "9682d77d7a811e1460210dae6edec4338bf37d6d553079e026ffdfdf5d23b360"
		)
	]
)