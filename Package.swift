...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-4.2.0-beta.29.xcframework.zip",
			checksum: "dfecf383b8f81c360979737cfa491ec34f8a1b36760246b95b388686525f1e63"
		)
	]
)