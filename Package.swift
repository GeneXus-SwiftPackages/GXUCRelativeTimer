...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-5.0.0-beta.4.xcframework.zip",
			checksum: "c0de2ac82c490872ab8cdd349bcebf82d1421e86defd0e26a51c6be84eea4d53"
		)
	]
)