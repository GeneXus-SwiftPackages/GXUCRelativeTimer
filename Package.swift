...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.3.0-beta.9.xcframework.zip",
			checksum: "7989ad41ec82fe50fa0e2b60585fbb8c867d01eef6d204a9d4d5e52b4a207a4d"
		)
	]
)