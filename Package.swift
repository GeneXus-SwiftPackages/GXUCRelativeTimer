...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-4.2.0-beta.7.xcframework.zip",
			checksum: "94d6dfcf6966239adc8dde3a7e2b06e0d435ca495d12956c89e2660f5ad2d6d2"
		)
	]
)