...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCRelativeTimer-4.1.0-rc.22.xcframework.zip",
			checksum: "46281d45490622cf81fcee295dc5b8d92b172cdab0024df3a17792ff65fbf0b0"
		)
	]
)