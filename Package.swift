...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-3.0.0-beta.13.xcframework.zip",
			checksum: "f2753a869eddf2370c2b81274b6e3f97044534b5bf5f82cb010d7cd69e5444e6"
		)
	]
)