...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.3.0-beta.1.xcframework.zip",
			checksum: "55c8d45546a11029bec98ff7a2e9e3c69cc5d501652ba16968cccb1cad38edde"
		)
	]
)