...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-4.1.0-beta.8.xcframework.zip",
			checksum: "7bf150e2c6c50cf19b9a09fedef1d37ee50ba9270aa6344faadc8ec744ccb747"
		)
	]
)