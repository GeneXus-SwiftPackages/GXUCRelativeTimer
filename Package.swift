...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.1.0-beta.6.xcframework.zip",
			checksum: "84173acda434d9109c5cf18ad0d4bcc4010f95fe33aaced7d04a10c9a10ab2d4"
		)
	]
)