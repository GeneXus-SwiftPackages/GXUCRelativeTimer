...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.2.0-beta.1.xcframework.zip",
			checksum: "3031ae6282541b19bcc071586c1a36913ef1c433cd06832318872fb147ab7d9f"
		)
	]
)