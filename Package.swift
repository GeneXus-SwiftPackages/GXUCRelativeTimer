...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-3.0.0-beta.9.xcframework.zip",
			checksum: "5d66494eab7bed1b43437bbf6fc56cdd9df46d0758275f202ffa29ea17d59f5b"
		)
	]
)