...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-3.1.0-beta.17.xcframework.zip",
			checksum: "832c607a70d8af40d6874ac734807da8d05ee14eac3ed014d819f7c69ded1cf8"
		)
	]
)