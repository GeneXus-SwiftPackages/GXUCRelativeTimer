...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCRelativeTimer-2.0.12.xcframework.zip",
			checksum: "d9bd4d0d18a17450a4acf52dad24f180675f28db701a8f3f7256f4919c6b1434"
		)
	]
)