...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-4.2.0-beta.33.xcframework.zip",
			checksum: "377bdd7fe20fa5ba45c5c23989e03b82a965083562dd03b8bbc6b5c4ceaddf91"
		)
	]
)