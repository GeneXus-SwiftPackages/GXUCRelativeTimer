...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-2.0.0-beta.23.xcframework.zip",
			checksum: "0871854304f50fcefb55fa045a34f642c587f4056ccdf08866fc689204e9cb75"
		)
	]
)