...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-2.0.0-beta.25.xcframework.zip",
			checksum: "285851bfc297af707f49b03b80f9c46912575a1f2faa5250075a5062a92a6c47"
		)
	]
)