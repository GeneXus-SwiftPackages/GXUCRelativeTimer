...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.5.0-beta.28.xcframework.zip",
			checksum: "6d9de79e4ad77bc410cd6a75d63dcb409302616f676b1ddd53bb9be0f3b732fb"
		)
	]
)