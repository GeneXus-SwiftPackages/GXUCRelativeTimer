...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.5.0-beta.19.xcframework.zip",
			checksum: "c09518f753291fd68ecf3c95fdadca37126d1532ca53332f2943dd47d2b277d5"
		)
	]
)