...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-4.2.0-beta.6.xcframework.zip",
			checksum: "abe8d4b5362a281bc68bc09c6e18d60f1482b2f99f9a96652ac7982d0fc42836"
		)
	]
)