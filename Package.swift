...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-2.2.0-beta.11.xcframework.zip",
			checksum: "662883b6baa56ebee9db3fd7a83a51a7bb4de17d45e431934e6313471f7f20c1"
		)
	]
)