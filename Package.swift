...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-2.0.0-beta.6.xcframework.zip",
			checksum: "bd24c13043688b82314d9abb4510696d758b8b101ea2c0cca6cadc1db3fe125c"
		)
	]
)