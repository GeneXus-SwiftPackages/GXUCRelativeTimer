...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-4.0.0-beta.47.xcframework.zip",
			checksum: "9ffe281c57e8dd9beaeeac6a80826d06e6c4e578620ee2fe0e67787d8196ae5e"
		)
	]
)