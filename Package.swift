...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCRelativeTimer-1.2.0-rc.25.xcframework.zip",
			checksum: "1c06738167e6a9362a5b2667dc34c52933f069b065e6eec39ab491c31a082d01"
		)
	]
)