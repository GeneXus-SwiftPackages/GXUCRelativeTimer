...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.2.0-beta.29.xcframework.zip",
			checksum: "c3460b3f0a08f8d75094818031ea55b5c44ae8c8bba6a99bf814b42bae82b0c8"
		)
	]
)