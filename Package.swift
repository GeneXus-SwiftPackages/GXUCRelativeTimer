...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.5.0-beta.6.xcframework.zip",
			checksum: "423e15dd0e5d1da48258b666be23609a32c925a1d458ad69e64121090ecbc27b"
		)
	]
)