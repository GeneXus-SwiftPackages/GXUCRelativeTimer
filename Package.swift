...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-3.1.0-beta.11.xcframework.zip",
			checksum: "c04ece0057285b8f552f4d11802ccf755e2105a526c44041a058e3e0fcd84e1f"
		)
	]
)