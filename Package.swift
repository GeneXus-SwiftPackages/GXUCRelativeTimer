...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-4.2.0-beta.20.xcframework.zip",
			checksum: "8b01e7e71c49a55f63afc8a6e1751a24c5b3973945642c640ebff7861586faf1"
		)
	]
)