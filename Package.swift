...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCRelativeTimer-1.4.0-rc.1.xcframework.zip",
			checksum: "c3fc2a3c6e5d39303c507013c96d786f73b0bce2c68d9c31b6603b10348b9e02"
		)
	]
)