...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-4.2.0-beta.25.xcframework.zip",
			checksum: "1b6b961f92a5691018266f98990680aa1cf9ead7bf40c80389a650cede830c78"
		)
	]
)