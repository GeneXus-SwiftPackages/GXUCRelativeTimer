...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-2.0.0-beta.33.xcframework.zip",
			checksum: "3d1265eb813f842f560f03dae821c1fa9686f79a5f0a0925c91b7c33da34e6a0"
		)
	]
)