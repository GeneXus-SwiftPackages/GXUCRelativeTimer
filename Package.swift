...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCRelativeTimer-3.0.7.xcframework.zip",
			checksum: "6a7923c80704f77c808ada7b9e416d7c2eb7c2bc7ba997133532a9ed054ca451"
		)
	]
)