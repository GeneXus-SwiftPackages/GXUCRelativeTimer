...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCRelativeTimer-1.4.0-rc.21.xcframework.zip",
			checksum: "177796281a32138795416a67b62d9fe8b8322c538d93a1d3db0030911456cc50"
		)
	]
)