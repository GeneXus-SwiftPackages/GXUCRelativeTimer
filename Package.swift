...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.6.0-beta.3.xcframework.zip",
			checksum: "d8ccef709fe7608064a913568275521c81cc815e2636d5cc5f605d45b48c9427"
		)
	]
)