...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-2.0.0-beta.31.xcframework.zip",
			checksum: "76adaefe71b5f6084e36b08342691d991a1bd8b3cba84a1c67f36e26ef38e11a"
		)
	]
)