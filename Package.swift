...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCRelativeTimer-4.1.3.xcframework.zip",
			checksum: "74ca08c73afaeb84897faf582d28b8d7b86e35742c823823d0c6dd0a4f6b988d"
		)
	]
)