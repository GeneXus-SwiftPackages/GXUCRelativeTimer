...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCRelativeTimer-1.3.0.xcframework.zip",
			checksum: "4323d13a52cbaf6f8839e5e46973945cb193e0395c5084a1e99ad1753f42005e"
		)
	]
)