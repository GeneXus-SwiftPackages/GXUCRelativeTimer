...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-3.2.0-beta.23.xcframework.zip",
			checksum: "6674af40d292d7e94af6f1991186857d924ab21ca890bbff7d721828f612db50"
		)
	]
)