...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.3.0-beta.4.xcframework.zip",
			checksum: "12cdb032e6042ac4f256ff7c64a666d1e56ff13758e93b8ec5091292adaec202"
		)
	]
)