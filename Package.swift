...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCRelativeTimer-4.2.0-rc.34.xcframework.zip",
			checksum: "84fe9489e01b45218a7a0427a7c675d5b459c3db1592bdec24c51458ea5c1168"
		)
	]
)