...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-2.0.0-beta.28.xcframework.zip",
			checksum: "29ffa2c00e9eedbe6a145fc77ecbd936eeac96bddf425d3dbbe21bb724e122d5"
		)
	]
)