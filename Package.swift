...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.5.0-beta.8.xcframework.zip",
			checksum: "a1dd5edf8c44167787019922e4e341c69b683aeeed98d6975628e2ffde75e226"
		)
	]
)