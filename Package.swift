...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-3.2.0-beta.33.xcframework.zip",
			checksum: "8addc18993e2c8c168e69c678bf09e352491b870ef3f7df91929239860cc1b5b"
		)
	]
)