...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.0.0-beta+20230420132651.xcframework.zip",
			checksum: "7628cb6428802f2e73e7ad28fa037820e353246e9704903aba8fbde06c4afb1f"
		)
	]
)