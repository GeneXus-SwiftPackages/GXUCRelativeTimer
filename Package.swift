...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.0.0-beta+20230518171417.xcframework.zip",
			checksum: "0d2662e4c6fa95e3ca4f53af06fdb0bd8e2a7688b9e3b11044a35ddf2532a22a"
		)
	]
)