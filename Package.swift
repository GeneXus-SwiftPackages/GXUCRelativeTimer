...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.2.0-beta.16.xcframework.zip",
			checksum: "8471bcf8d268c583888f78095c72d97bb1fdb410e45aa038ccf5e63eab8991e5"
		)
	]
)