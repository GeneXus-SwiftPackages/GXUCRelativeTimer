...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCRelativeTimer-4.2.0.xcframework.zip",
			checksum: "653444f2434e4bfe2623ae0a7b627d379c8581cf62d6f9ae7c08401b40175179"
		)
	]
)