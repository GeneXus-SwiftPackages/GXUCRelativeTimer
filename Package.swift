...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCRelativeTimer-1.1.2.xcframework.zip",
			checksum: "d35c0e96b72f6163d9d2b5b3753c8bb8b7d9278c89dee542461630958b3d68bf"
		)
	]
)