...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCRelativeTimer-5.0.0-rc.0.xcframework.zip",
			checksum: "5065457ff0818b3cbcc7190d4dbef1dfb11da741611ab132237fe62a3026f9bf"
		)
	]
)