...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-3.1.0-beta.2.xcframework.zip",
			checksum: "991ae927fa7f4d5cd80a2dbdc3ffed94d7eea07bd4aef37e04353cdaf7497937"
		)
	]
)