...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-4.1.0-beta.3.xcframework.zip",
			checksum: "8b807cab01f57a469be6c8f44e5607458ae48eb872602fc85a5b4679e1b1d4fc"
		)
	]
)