...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-4.1.0-beta.24.xcframework.zip",
			checksum: "812898093ecdbb14ba960c84fc31348889316455f0447deaadf2808e5cbaf35c"
		)
	]
)