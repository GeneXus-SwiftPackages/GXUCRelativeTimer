...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-2.0.0-beta.40.xcframework.zip",
			checksum: "8095f5b34d9eddb26c32315c014786ccccd243593c34154b959ea62a8072cab1"
		)
	]
)