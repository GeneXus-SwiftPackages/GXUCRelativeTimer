...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-4.0.0-beta.44.xcframework.zip",
			checksum: "47c2563b1a1d2dcee3aaf15e14b67f6bb4942818af704ae399745c00ee2032cc"
		)
	]
)