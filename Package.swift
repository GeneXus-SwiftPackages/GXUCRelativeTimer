...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-2.0.0-beta.20.xcframework.zip",
			checksum: "84eb44b0fb759e155b7be75afc8c66f7a3f3561ef251db1058edb9d3e715fdc4"
		)
	]
)