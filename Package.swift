...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-2.0.0-beta.30.xcframework.zip",
			checksum: "b5f567c4071e342f442c7b92a0a060aafadf1ef9a779fb6ef2eee61d6b08a202"
		)
	]
)