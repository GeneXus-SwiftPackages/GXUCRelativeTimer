...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.2.0-beta.17.xcframework.zip",
			checksum: "dc50753b729ca0b564e74687353d0c9f3c40ffc072f3c4376fe1e0bab07b2f4f"
		)
	]
)