...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCRelativeTimer-1.5.0-rc.2.xcframework.zip",
			checksum: "451b5dafbbbbc24c174dfb98ecf68d29747984f7452263530d9030732145299b"
		)
	]
)