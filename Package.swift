...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.6.0-beta.0.xcframework.zip",
			checksum: "0b96a5987b35174427dd54c15295a69734d42c2e527130d3b12656c6ae9b58ad"
		)
	]
)