...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-2.2.0-beta.14.xcframework.zip",
			checksum: "2a943a07564653da8c7750a195fd6f86ecc8ad0f93ca52d16768cecc335cf596"
		)
	]
)