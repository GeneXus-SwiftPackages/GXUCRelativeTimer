...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.4.0-beta.12.xcframework.zip",
			checksum: "e2dc569fa868256a6758cf94dfebdeea049aa8f3367ca70b7b369dcfebe4e96a"
		)
	]
)