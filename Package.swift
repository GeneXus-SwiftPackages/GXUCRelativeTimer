...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-3.0.0-beta.15.xcframework.zip",
			checksum: "130c9acbe1dfe0ae97041f9861c018b2fe16893448ca1585064f729df91c0a06"
		)
	]
)