...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.4.0-beta.6.xcframework.zip",
			checksum: "b0f784fd127ecc954ea9ba4a336f3a031bb2add40a05939fb95d770684bd6922"
		)
	]
)