...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-3.2.0-beta.37.xcframework.zip",
			checksum: "3c2925c8a78ac9d601ec6bbdbad69f4eb611ee21574d158a4ed562ee6d41c9ce"
		)
	]
)