...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.4.0-beta.18.xcframework.zip",
			checksum: "e0cedb5a317948a29c21a50b847e2bfa993511708e0853aacd3e97914ab240cc"
		)
	]
)