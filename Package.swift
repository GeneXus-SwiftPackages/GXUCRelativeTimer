...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCRelativeTimer-1.5.16.xcframework.zip",
			checksum: "aaab1ed973e7af89b7d48ce8aa96d73b2a2fd5d0de14a09e436a85179768c5af"
		)
	]
)