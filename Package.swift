...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCRelativeTimer-2.0.0-rc.36.xcframework.zip",
			checksum: "0a504d02f8e8ef922ecb8e2f7c13bd2efffc2fbccbeb0b4d85cca32c34d77f82"
		)
	]
)