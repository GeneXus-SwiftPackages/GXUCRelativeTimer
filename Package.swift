...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-3.2.0-beta.11.xcframework.zip",
			checksum: "e79c0f8b14bcc6a66e91a40723d1e17e39ea999b0ad75997cc97d9b43b2be594"
		)
	]
)