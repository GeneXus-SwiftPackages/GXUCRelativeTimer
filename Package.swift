...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-3.1.0-beta.15.xcframework.zip",
			checksum: "d74582a797b5915e59f6cb6fe88d8f23290b40c7cf184578500b0446c55c3d0c"
		)
	]
)