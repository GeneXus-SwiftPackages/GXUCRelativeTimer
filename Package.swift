...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.2.0-beta.28.xcframework.zip",
			checksum: "646c7ae9dc24f31683dea06204c2be05a1f238571f40e6a5daab603811f781c6"
		)
	]
)