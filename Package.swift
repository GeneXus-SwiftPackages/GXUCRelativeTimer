...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.0.0-beta.20230630183632.xcframework.zip",
			checksum: "e14e2e117c4abeda194392b5f3bc5e5729f0be871a374d988df012b5aebe06c2"
		)
	]
)