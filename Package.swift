...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCRelativeTimer-1.1.3.xcframework.zip",
			checksum: "180dd779fb8560f275ccbc4d95d825c3d2e7ba18b59c101402fe7d3201fb8b2c"
		)
	]
)