...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCRelativeTimer-2.0.0-rc.22.xcframework.zip",
			checksum: "55df61f480a46be36195aded5fcb382950f7de0600af801c77cdc28d02492e0e"
		)
	]
)