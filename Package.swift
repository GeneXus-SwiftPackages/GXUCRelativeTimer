...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCRelativeTimer-2.1.0-rc.23.xcframework.zip",
			checksum: "21af4aa9dcfc328ac64b647c9489975b3a9c08cc7501d060c33201949c9701d6"
		)
	]
)