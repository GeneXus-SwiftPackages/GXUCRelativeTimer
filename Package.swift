...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCRelativeTimer-1.1.0-rc.3.xcframework.zip",
			checksum: "9d297381c4aa44599f1bdf6d59fc703955b104222d385def651931da8086c293"
		)
	]
)