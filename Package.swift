...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-4.2.0-beta.35.xcframework.zip",
			checksum: "2069ac5d896adf0b8468e46e8e36e6e4beca99c92edfa13dcee1dfb66eb0b240"
		)
	]
)