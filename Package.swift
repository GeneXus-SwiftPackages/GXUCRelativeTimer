...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-3.2.0-beta.6.xcframework.zip",
			checksum: "05172849b95daaea0cdd4ae36f32fb30bd85dfe8e3f3f3aaaea0ec8732ef468d"
		)
	]
)