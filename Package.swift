...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCRelativeTimer-1.3.0-rc.1.xcframework.zip",
			checksum: "39be95bd066497701afcdbcb48d3bc2b6babb8712cd4dc78c7f607a2554c8c82"
		)
	]
)