...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-3.0.0-beta.10.xcframework.zip",
			checksum: "e414361b180018790f872c7fcc4f4b366b1fe4830f3a8bf9205d9d8837cb40fd"
		)
	]
)