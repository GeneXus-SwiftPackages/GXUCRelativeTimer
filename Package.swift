...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-4.2.0-beta.12.xcframework.zip",
			checksum: "7ccda6870d7d429afa3fdd37e8031dc89009738b377d83ecac028ff0a5a4f85f"
		)
	]
)