...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-3.0.0-beta.8.xcframework.zip",
			checksum: "d6da79baf916afee0d31621c8fce58e6bf0301ccf062b4e0d257a3194bed1b3f"
		)
	]
)