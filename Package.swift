...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCRelativeTimer-1.4.27.xcframework.zip",
			checksum: "d3fcc83f969e39b5b682609c2728ea9336aef6f6349a69c5994f887a222f4857"
		)
	]
)