...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCRelativeTimer-1.3.0-rc.13.xcframework.zip",
			checksum: "da4635f7162c533fa1caf3b27ebdae9f6642c67dc7ee8e8522afffe1532622d3"
		)
	]
)