...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-4.2.0-beta.37.xcframework.zip",
			checksum: "aa3a8b98450b9e410338749cb7d2f8ebca4474fd110bd82780c070299e88ba1b"
		)
	]
)