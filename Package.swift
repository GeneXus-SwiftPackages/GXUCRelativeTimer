...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.2.0-beta.23.xcframework.zip",
			checksum: "e184b7dc385cb2be8d6e51f12950f6683f3429d4075c7a32459d96ad3cdad48d"
		)
	]
)