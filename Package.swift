...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-3.0.0-beta.16.xcframework.zip",
			checksum: "9a42da867df5cdb4e8534a47e5dd66a464129520d5d518ed92677b437ad6540d"
		)
	]
)