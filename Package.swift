...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCRelativeTimer-1.4.31.xcframework.zip",
			checksum: "a736cf63128f04fd2f15eb689b5dbf053c15eb64834cc3010c8106b514563a55"
		)
	]
)