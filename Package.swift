...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.4.0-beta.20.xcframework.zip",
			checksum: "387f06fe9e72cbba8356deb55ca7430ceb5468c906a8281cc6e3a18a1f4344c8"
		)
	]
)