...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCRelativeTimer-4.2.0-rc.37.xcframework.zip",
			checksum: "c93d26c8cc7550a4a29cd396024c9c2b9b793fe06187c7acef57fc0480648a00"
		)
	]
)