...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCRelativeTimer-4.2.0-rc.3.xcframework.zip",
			checksum: "efecb6ecaeb1a55b483660f94fd83addac85de2fdc9fb8ef6f71d86e8a2fad78"
		)
	]
)