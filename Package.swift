...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-4.2.0-beta.38.xcframework.zip",
			checksum: "8b45f80e9effce24aed719c23879e7b2ca9e7ad776b5ff46fce8995ad9e1ac2b"
		)
	]
)