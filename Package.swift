...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.0.0-beta+20230314121632.xcframework.zip",
			checksum: "27dc7848a9be2f0db2516096e549f6d1f899741878cb159781eb549ad9bc07c1"
		)
	]
)