...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-4.0.0-beta.49.xcframework.zip",
			checksum: "c5a9a70192cd458e43520c839992862e57e6e1cd7e6c57dbcd78e6bcf84774e5"
		)
	]
)