...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCRelativeTimer-5.0.0-rc.1.xcframework.zip",
			checksum: "8c131de4c14fd3712820219ef11bf1f14bac0d9fc90ee726d026462c8331f543"
		)
	]
)