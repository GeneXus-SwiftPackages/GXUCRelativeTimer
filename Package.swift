...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCRelativeTimer-4.0.4.xcframework.zip",
			checksum: "6f27a30299cb0aa524c13af6035dc7bbabff4b07fb81e2b654cabe67f6f36405"
		)
	]
)