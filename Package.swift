...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCRelativeTimer-4.0.0-rc.43.xcframework.zip",
			checksum: "18158b218f2e27c7118a70d41ffa09e73cffa500727a3a4396b0aa2e69d9d7a0"
		)
	]
)