...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.5.0-beta.24.xcframework.zip",
			checksum: "fd595bf3a54d1c379e3146ed7f72d9a9e1aa512cf739332ee58114a5ed06e979"
		)
	]
)