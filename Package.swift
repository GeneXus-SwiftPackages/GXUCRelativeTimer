...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.2.0-beta.30.xcframework.zip",
			checksum: "1e861de9cfd5f37b0d603b76d695c3b63ffa75bd6aca6dcec6c52a818e649987"
		)
	]
)