...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-4.2.0-beta.17.xcframework.zip",
			checksum: "b10e87399ae8ea283e4d77c7d22ebd18211080bad5d9e9330683b055fdcf61b9"
		)
	]
)