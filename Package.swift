...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCRelativeTimer-3.0.0.xcframework.zip",
			checksum: "ce3091c2399ad158510a7c09d56f84c16b17075d7151cf76b174ddfbd13b7f28"
		)
	]
)