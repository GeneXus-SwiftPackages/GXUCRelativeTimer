...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCRelativeTimer-1.5.17.xcframework.zip",
			checksum: "2ee7f6c46422cc7088ec7b931cc2ecc7cb5a7b0659238840e34c67db51215885"
		)
	]
)