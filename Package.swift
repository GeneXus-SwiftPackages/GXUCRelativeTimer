...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-4.1.0-beta.22.xcframework.zip",
			checksum: "41eaf8a11003b4ed8606218b6f00ad0eae8c648038b81fd49990a566e2fdd190"
		)
	]
)