...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-4.2.0-beta.31.xcframework.zip",
			checksum: "d5d27a2d54ade16b87bc2a9990657e20c89bd9661d9b31e1eda44f3a2571a4a5"
		)
	]
)