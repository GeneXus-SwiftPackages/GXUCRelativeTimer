...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCRelativeTimer-1.3.5.xcframework.zip",
			checksum: "a1620c4b5f4810f789ca859dc19cf920c4566d56c1444723d15e50a3fc23c4bb"
		)
	]
)