...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-3.1.0-beta.25.xcframework.zip",
			checksum: "a2eb2fd3be5b966b0315fa76b67e722207ade934df607e844b3682b18642ce2e"
		)
	]
)