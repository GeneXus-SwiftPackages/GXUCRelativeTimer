...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.4.0-beta.16.xcframework.zip",
			checksum: "c6afa9f6cce4d6cb381e4372e383a50b734ae6ace3cf1be7a006559d7e98f6d7"
		)
	]
)