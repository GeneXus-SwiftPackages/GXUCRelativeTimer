...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.4.0-beta.14.xcframework.zip",
			checksum: "1534fa7a9eb2c013e090a5a2084fc41f5036b769981a4d0f64a9f3d4ba29aa72"
		)
	]
)