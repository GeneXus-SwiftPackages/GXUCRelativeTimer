...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCRelativeTimer-3.0.3.xcframework.zip",
			checksum: "f858a8776b90610c93ab34e8f794558d11d9924b8592a05704fd8fa86a2aaa92"
		)
	]
)