...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-3.1.0-beta.0.xcframework.zip",
			checksum: "9f1b1add648f7f1804692ab2d0d208fb9e9369e1bdb52a2d55da3ec0cea3cfba"
		)
	]
)