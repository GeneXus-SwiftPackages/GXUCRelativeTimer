...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCRelativeTimer-1.4.29.xcframework.zip",
			checksum: "e9e7f1cea9b227a572daa971984539be114e16568afde92c368f84b4a9099eff"
		)
	]
)