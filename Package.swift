...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCRelativeTimer-4.0.0.xcframework.zip",
			checksum: "be9842a4fd9cfc27987dc3c7865fd5f259ed91db135db97926539d53ae47a200"
		)
	]
)