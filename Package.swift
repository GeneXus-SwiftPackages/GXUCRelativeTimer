...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.5.0-beta.4.xcframework.zip",
			checksum: "36166c47dcb41cafab90a4e94a77050c0046ec2e025561cff6d90f280be17e7d"
		)
	]
)