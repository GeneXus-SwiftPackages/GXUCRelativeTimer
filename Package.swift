...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.6.0-beta.2.xcframework.zip",
			checksum: "b2434b8e8158cc5ad5ac56dc897c4575d0d20b984050010d667d2c571cc7b8a7"
		)
	]
)