...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.5.0-beta.9.xcframework.zip",
			checksum: "e635f2a4c1de59381b3dde769a57cb6f9a51a6432dabd97d91e40bee842c0ade"
		)
	]
)