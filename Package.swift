...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCRelativeTimer-4.0.2.xcframework.zip",
			checksum: "4613e133940431a8a51e604c29e90aead52b2e7cf30052b1408b0089b15f5141"
		)
	]
)