...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-4.1.0-beta.23.xcframework.zip",
			checksum: "de5c6cc2177a2d5d3c4a44feddc90cee8071e0f25c3944ee94e6463f332a057d"
		)
	]
)