...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-3.1.0-beta.24.xcframework.zip",
			checksum: "b5f68bbfd8296e5381243efe31b25ada173e7d68f30a69b5d4fee267247f8037"
		)
	]
)