...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCRelativeTimer-1.5.12.xcframework.zip",
			checksum: "bc39a3d2d9d9ea0b2b49d36d1ffa4272f2491fcc491b57f0d7061a1b0d8914e8"
		)
	]
)