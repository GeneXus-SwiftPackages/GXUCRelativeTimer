...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-4.2.0-beta.21.xcframework.zip",
			checksum: "83c685bebba8aa8c46dfc6ff30c80b711a5b8cfcaa1ca0527c6b18f3d4aa68ab"
		)
	]
)