...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-2.2.0-beta.8.xcframework.zip",
			checksum: "864aa1bff77e33b0ef6d6da3c0cec4a9085c11a7eca1284adee9863a8da98860"
		)
	]
)