...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-3.2.0-beta.13.xcframework.zip",
			checksum: "5835ae888541dd5915d3c429395758acda5528d7ed0a70b76c7c2655db713b46"
		)
	]
)