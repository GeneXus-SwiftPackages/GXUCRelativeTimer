...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCRelativeTimer-4.1.5.xcframework.zip",
			checksum: "ef1d5923b08fd000c159f83db677d8e6ec576a18577041aafd9f01096309e220"
		)
	]
)