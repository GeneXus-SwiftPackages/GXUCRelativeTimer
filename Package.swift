...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCRelativeTimer-3.0.0-rc.2.xcframework.zip",
			checksum: "6944adbad8d75fd8101b9e19e978358fa2dad407631368a0eb6b4303825a997a"
		)
	]
)