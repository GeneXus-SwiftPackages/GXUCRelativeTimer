...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.4.0-beta.19.xcframework.zip",
			checksum: "d1f68e63fb0b3db03ef0a791fb8c3fda96b2022c478b58d884a03f8ebb74855f"
		)
	]
)