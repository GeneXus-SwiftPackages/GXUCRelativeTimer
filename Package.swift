...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCRelativeTimer-3.1.0.xcframework.zip",
			checksum: "693dcbb12dbb5d10fea44af2be67daf751e0ae20b772ba7a21bb96dea80e9c57"
		)
	]
)