...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.4.0-beta.5.xcframework.zip",
			checksum: "c50c9d3193838404b0a0892d25df30a8d047c03e9b4b000de8b6c439ff06af0a"
		)
	]
)