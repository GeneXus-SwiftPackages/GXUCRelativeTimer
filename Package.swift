...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-2.2.0-beta.12.xcframework.zip",
			checksum: "fdfd928c852504afd40eabdb1861a76e6cbcf8fcb7ba9e85e76071c631b13af4"
		)
	]
)