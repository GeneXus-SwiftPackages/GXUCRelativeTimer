...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.2.0-beta.18.xcframework.zip",
			checksum: "938c0fa8cfb40b8fcfa5423d05a72fd0817bc19c6a6a76461a38bdc5cbb24133"
		)
	]
)