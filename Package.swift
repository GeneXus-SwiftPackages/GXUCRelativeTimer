...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-4.2.0-beta.24.xcframework.zip",
			checksum: "6863e778334abe499ecb2d89ef75f308eafd1b73f1958b170ca2752f44f587db"
		)
	]
)