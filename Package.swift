...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-2.2.0-beta.24.xcframework.zip",
			checksum: "59af5c8535bec484f36ce05284f8fd469f8b91e064907ca48d71b85d492033cf"
		)
	]
)