...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-3.2.0-beta.41.xcframework.zip",
			checksum: "51cf4ab89b17b253394ffdfbc82004c31dce48261ff148e30ec8fe8987075015"
		)
	]
)