...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCRelativeTimer-1.3.3.xcframework.zip",
			checksum: "8c249048bde5cbc28ed6d4d8053867c4fc0f2cbd152346ef434291897f7bf8b1"
		)
	]
)