...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-3.1.0-beta.19.xcframework.zip",
			checksum: "b5a1806eac7008da562098477f8d4f521c9e4b95ab8e0cbe541618a837c73f21"
		)
	]
)