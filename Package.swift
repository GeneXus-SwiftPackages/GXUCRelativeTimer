...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCRelativeTimer-1.5.0-rc.28.xcframework.zip",
			checksum: "f86ebff2315de7ebc0ac197ffd10cc545f09c7ddcebdee7bd3159284556532c3"
		)
	]
)