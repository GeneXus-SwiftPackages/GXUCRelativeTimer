...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.4.0-beta.2.xcframework.zip",
			checksum: "6e4d1de516138d6fbabf347b5920683455dc3da4a1a26c1f9b6b658d6cb9bd68"
		)
	]
)