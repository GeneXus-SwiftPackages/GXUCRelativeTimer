...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.0.0-beta.20230614190626.xcframework.zip",
			checksum: "df1fe747e022c0fdae181b5f297f258f2601f62fbbebb4a6ddaf5af41ba2152e"
		)
	]
)