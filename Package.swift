...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-4.0.0-beta.45.xcframework.zip",
			checksum: "ec15b3382463fa2d4d7d39d61434d93f200f58974b12f92d98a236c1f24f4af8"
		)
	]
)