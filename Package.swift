...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.2.0-beta.19.xcframework.zip",
			checksum: "0374fae8f894d9a7f1781bc4387c0332455ad32af3e615865dbb670b7c8aa14d"
		)
	]
)