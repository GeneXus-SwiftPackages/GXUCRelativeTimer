...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-3.0.0-beta.12.xcframework.zip",
			checksum: "971e5f59ec0508cd8ad62c05e97b6462e4f57730726bff8f9fad7d0b64b56a88"
		)
	]
)