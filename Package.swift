...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.2.0-beta.32.xcframework.zip",
			checksum: "5dbbf9589d3222686460427807713929c524998be0a29e8cc63675b6c4a40e71"
		)
	]
)