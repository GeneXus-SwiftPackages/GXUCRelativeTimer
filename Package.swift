...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCRelativeTimer-1.2.1.xcframework.zip",
			checksum: "142b399af01d7b5bfbde38258900ad814e27ab48cb45e1810540748d21a6f193"
		)
	]
)