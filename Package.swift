...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-3.1.0-beta.12.xcframework.zip",
			checksum: "454a2a167a46f15ac0ba620ced343dfb29f4345e2f19dc86032a9491ad5b8858"
		)
	]
)