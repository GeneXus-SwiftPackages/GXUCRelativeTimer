...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.2.0-beta.33.xcframework.zip",
			checksum: "128fc9bba4f1567fd34974c35b5a3f98f76094eb0f78807a5c6887f83fdffa11"
		)
	]
)