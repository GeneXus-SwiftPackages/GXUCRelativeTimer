...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-2.0.0-beta.39.xcframework.zip",
			checksum: "fa220a35809e7e325392b04ce069290e68b25539577230ef4d14dcde0bcbbd0d"
		)
	]
)