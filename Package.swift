...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.3.0-beta.11.xcframework.zip",
			checksum: "0147e683570e2d89c1c7b0304166683d2f71d3e081ecb37914596031680a0b5a"
		)
	]
)