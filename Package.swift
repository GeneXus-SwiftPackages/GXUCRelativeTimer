...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-5.0.0-beta.1.xcframework.zip",
			checksum: "932e5ca7016f20c58e224c90bedfbd4915201d512d28aeef1cab2d5c1876892b"
		)
	]
)