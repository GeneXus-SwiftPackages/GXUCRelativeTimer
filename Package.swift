...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-2.2.0-beta.21.xcframework.zip",
			checksum: "2795581d49e2f46ab06c40591f72da40cae9562ca6def847ea7e9466d8e53634"
		)
	]
)