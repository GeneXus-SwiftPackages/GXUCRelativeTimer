...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-2.2.0-beta.13.xcframework.zip",
			checksum: "68e1216040f7fce8cb80b29dcf90e9523a4fccdaced180d51276409e45ec2423"
		)
	]
)