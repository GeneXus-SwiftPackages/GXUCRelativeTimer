...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.5.0-beta.18.xcframework.zip",
			checksum: "3b5e33c7c5a3088bd436a1455501b8be06da55690511cfc7a8cd82e7b29419f2"
		)
	]
)