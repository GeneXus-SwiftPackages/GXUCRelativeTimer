...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-2.0.0-beta.35.xcframework.zip",
			checksum: "e7eb307f3434ddb2b2b922a016fa3b90cd3dc7c745b46e9235b9db980e248acb"
		)
	]
)