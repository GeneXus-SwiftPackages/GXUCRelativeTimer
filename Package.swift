...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-2.2.0-beta.26.xcframework.zip",
			checksum: "b35b8f86eea9087a70f899a712f53b0a27632255ed10da219c1346f6c193f1ae"
		)
	]
)