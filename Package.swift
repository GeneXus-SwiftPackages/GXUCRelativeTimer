...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-3.1.0-beta.9.xcframework.zip",
			checksum: "1f07184e400a70dcc872e4dbc7a5b2b4c8685b186b53edbc5731c696021b17e4"
		)
	]
)