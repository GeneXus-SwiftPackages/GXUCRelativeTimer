...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-2.0.0-beta.32.xcframework.zip",
			checksum: "b47a9f35e8317425a7f4eace35207c1275929419ac3d135473a2864cb01db2ab"
		)
	]
)