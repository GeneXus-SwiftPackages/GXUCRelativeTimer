...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-2.0.0-beta.36.xcframework.zip",
			checksum: "e0348779efaeb94c0e35f1915b0aadefd17221d4c6b441dabee69078e1cf3909"
		)
	]
)