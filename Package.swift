...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCRelativeTimer-1.5.0-rc.26.xcframework.zip",
			checksum: "04d47b54ee987867aafa1a141bb23f11d5687d043bcb1e586763a7674e17804e"
		)
	]
)