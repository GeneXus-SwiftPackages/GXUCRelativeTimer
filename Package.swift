...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-4.2.0-beta.3.xcframework.zip",
			checksum: "de54030ff95340385f3b3fa0995ac5e4e8ff179529efb3825de308a415b76915"
		)
	]
)