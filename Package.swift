...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-3.0.0-beta.2.xcframework.zip",
			checksum: "9eb6b8e2e8252fca6c414ca11099de0def6896ba9c6f7e4b70dcc792e6d9096e"
		)
	]
)