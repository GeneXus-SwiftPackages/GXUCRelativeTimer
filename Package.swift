...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.1.0-beta.7.xcframework.zip",
			checksum: "05c4974c1f2a464ca7a95c525c51737ceed141c536c8704ca5186e030ace10ef"
		)
	]
)