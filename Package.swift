...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.1.0-beta.12.xcframework.zip",
			checksum: "a443907b11f3731f6cb4ab45ad861ae0e04018a805f2cbd053ae31cb369e8dbe"
		)
	]
)