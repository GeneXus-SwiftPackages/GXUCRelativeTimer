...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCRelativeTimer-1.3.0-rc.7.xcframework.zip",
			checksum: "500b736048510ad4db5a8f80fbadc08d51f6776c683c56ef168513ef446244b8"
		)
	]
)