...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-4.2.0-beta.14.xcframework.zip",
			checksum: "46b25910ee72e7b5ea52678d56330bbb7dde8a84801fa90babb9672a8b24f0b9"
		)
	]
)