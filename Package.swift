...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-2.0.0-beta.7.xcframework.zip",
			checksum: "459a92cdf7ce204ee96c17d0f98b67d08c1301b264d1b4e9f03ed372d9c52751"
		)
	]
)