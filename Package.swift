...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.2.0-beta.24.xcframework.zip",
			checksum: "2ed7a5924231a4688443519b46951ae4bd6d3e85a91ad902f001bac0974b85d6"
		)
	]
)