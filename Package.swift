...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.1.0-beta.794.xcframework.zip",
			checksum: "72a36a392321ad4efafad63ffe88b8ebf3f6ec473bc9cdc96aac46a144b2cdd4"
		)
	]
)