...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.2.0-beta.14.xcframework.zip",
			checksum: "a316de98ef09f06db032c5766759a6ae8825445cf128e871f9494743c1c7a8ac"
		)
	]
)