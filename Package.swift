...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.0.0-beta.20230706165352.xcframework.zip",
			checksum: "a97021be0feed0d4f9056907db7676a4278576619306cfe5c8326b4d72741a5e"
		)
	]
)