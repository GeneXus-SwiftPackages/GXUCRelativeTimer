...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.1.0-beta.5.xcframework.zip",
			checksum: "44581a4bc4f005c81ec21ae19260396e315a499e66a9303a39edb49d6af602cc"
		)
	]
)