...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-3.1.0-beta.27.xcframework.zip",
			checksum: "136ba778162fc70e8906138ef672c4b967b11fbb9aa4a59d6a4763cede733a94"
		)
	]
)