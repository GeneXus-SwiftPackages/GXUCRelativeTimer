...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-2.0.0-beta.5.xcframework.zip",
			checksum: "5c5ce23b6ad94d8a5041bad2ee9f89ccb2d9b15bf6da1286d8ebff6dabfeebb8"
		)
	]
)