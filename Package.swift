...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCRelativeTimer-2.0.0-rc.34.xcframework.zip",
			checksum: "9c2e864d43d0abfb658d82c7ee63423461e5260840a4cc21a92b00c4c44ca623"
		)
	]
)