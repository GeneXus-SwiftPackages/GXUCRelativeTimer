...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-3.1.0-beta.18.xcframework.zip",
			checksum: "7509fc281e442638566a4e71ef2daf994d14d464791a69890b5f0f19f677ad79"
		)
	]
)