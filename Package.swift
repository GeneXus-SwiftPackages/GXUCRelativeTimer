...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-2.1.0-beta.26.xcframework.zip",
			checksum: "eb259a97b2e87c60c51c1ce6d5bf472be24c19e89459b6646314a0999fe33e87"
		)
	]
)