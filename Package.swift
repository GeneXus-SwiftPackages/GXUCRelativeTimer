...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-2.2.0-beta.17.xcframework.zip",
			checksum: "d23b30530ffaae6cb88b2368d0cf801953ca92582c9b47000c2138029137fcdd"
		)
	]
)