...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCRelativeTimer-1.3.6.xcframework.zip",
			checksum: "d9e8bfcffb1df2d77819b3c0ebf8f55174f61fb2ba3bad062a05f8e966e41dfa"
		)
	]
)