...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCRelativeTimer-4.0.9.xcframework.zip",
			checksum: "9e3d5609876ce1718727de1aacc0964afaa6af28642ea723c92c8629a1c211e7"
		)
	]
)