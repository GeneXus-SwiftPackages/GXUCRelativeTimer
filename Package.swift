...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-2.0.0-beta.38.xcframework.zip",
			checksum: "d568d1ea1b724af0a5e8427670bcb75986538f19894687b5e573a87d2ce3646e"
		)
	]
)