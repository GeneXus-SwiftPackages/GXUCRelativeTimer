...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-2.0.0-beta.26.xcframework.zip",
			checksum: "762a4178346751dbcd1cc15cfb4df78e989ab4778988cf2dbcd522517369500e"
		)
	]
)