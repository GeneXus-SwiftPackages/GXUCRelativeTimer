...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.4.0-beta.4.xcframework.zip",
			checksum: "90c7940a86424ea12419b403761973a4311c137a5311e52614d9d8fc836e6f84"
		)
	]
)