...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-3.2.0-beta.19.xcframework.zip",
			checksum: "f3ae60f8b8a11c66e0447e22d42ab03a491a8ee9ec509260131e21efacb7e457"
		)
	]
)