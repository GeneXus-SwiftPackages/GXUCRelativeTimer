...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-2.0.0-beta.29.xcframework.zip",
			checksum: "565d884cd4e109d72adab5323ed23135733ec355205a20ba9c272881417852a9"
		)
	]
)