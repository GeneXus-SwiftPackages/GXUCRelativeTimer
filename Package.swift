...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-4.1.0-beta.6.xcframework.zip",
			checksum: "379538fed4ae1b16f941f2ef489ac05fab3a64ead65df4c0f5a3f353b1a39880"
		)
	]
)