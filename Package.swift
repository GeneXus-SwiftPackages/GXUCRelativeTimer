...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCRelativeTimer-3.1.5.xcframework.zip",
			checksum: "9c32f6e5dcc338f99ebe84b447fa498cdef0190a3bda7ad1a159c2cb7df62c72"
		)
	]
)