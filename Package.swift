...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCRelativeTimer-2.1.0.xcframework.zip",
			checksum: "c25b5e2a3451e78a9b0e356dc18b9f311661292711e989dca9d03c1d582f7858"
		)
	]
)