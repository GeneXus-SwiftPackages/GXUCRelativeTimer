...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-4.0.0-beta.51.xcframework.zip",
			checksum: "4ab369444342b8f1d1471ef7415e3ca995ad82c4a976faf695838ba50f1d36f6"
		)
	]
)