...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-3.1.0-beta.1.xcframework.zip",
			checksum: "b74d6b3f21d0bcb1fce67a349c214984f67c5e61c7e2dbc3a1a4cc9e91e0d30d"
		)
	]
)