...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-3.2.0-beta.10.xcframework.zip",
			checksum: "47513efa941fc21c71092e665442120260d02c6c842f57e993f5d901adf83170"
		)
	]
)