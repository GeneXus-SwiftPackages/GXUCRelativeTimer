...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCRelativeTimer-4.2.0-rc.0.xcframework.zip",
			checksum: "1400b689c152cdde9807ee1c0d6e75ea52bd79d56b01a39f811486ba8918b8fc"
		)
	]
)