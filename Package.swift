...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-2.2.0-beta.30.xcframework.zip",
			checksum: "e8d1533fcd0396a5a79154849e36ebf23f2d3221c92a0b332c5aac0751bf8d14"
		)
	]
)