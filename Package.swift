...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-3.0.0-beta.14.xcframework.zip",
			checksum: "58bc2f7b897187cd773d8367b1b5a4d5a0fe9a62c4294e5c48fd3734cf62648f"
		)
	]
)