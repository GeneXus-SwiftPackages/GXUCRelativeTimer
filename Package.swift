...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-2.0.0-beta.22.xcframework.zip",
			checksum: "e9d88a8f7f94524e11d516181621277ec9758e7100de563fd210f4f3e1b1e5db"
		)
	]
)