...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCRelativeTimer-1.2.0-rc.15.xcframework.zip",
			checksum: "f6042b2b9643379e6eb1f7d956d055c23a880b633ac5415501733265ca2b7a5e"
		)
	]
)