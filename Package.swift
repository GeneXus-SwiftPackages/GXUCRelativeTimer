...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-4.1.0-beta.13.xcframework.zip",
			checksum: "25b44b6166001afec7e54a53331aa7ef8042fee5d8fdaf93ff9d1ffc22a2dc86"
		)
	]
)