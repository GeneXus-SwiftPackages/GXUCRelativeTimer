...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-2.1.0-beta.25.xcframework.zip",
			checksum: "ed454a977f008741430830e8ce5195a10cce617dc246a6106da951a663bbe3f1"
		)
	]
)