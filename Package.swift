...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-2.0.0-beta.18.xcframework.zip",
			checksum: "90ced4ac0c85232fc0b58bf6141390328b7977767358cbe8f93fc1a56210cacd"
		)
	]
)