...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.1.0-beta.795.xcframework.zip",
			checksum: "91527ee57eb6e95d04a021a5d4c15bb72c3edf3b129b1bd1d81025ae16ec699b"
		)
	]
)