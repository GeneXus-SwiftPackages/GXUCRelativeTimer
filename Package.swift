...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.4.0-beta.7.xcframework.zip",
			checksum: "0690c63a93edb7935798ef231e622007cebee76053542ef58d7f5b3964d36d64"
		)
	]
)