...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCRelativeTimer-4.0.17.xcframework.zip",
			checksum: "6edbd4f01b69cb9af62cf64d61b2f21bf17b78d4d76b83225604d38f1a143e53"
		)
	]
)