...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.3.0-beta.6.xcframework.zip",
			checksum: "f4c40e9f1913bd2de39004a3f7ac16f7e3194ee502831a1caa5f871f04f26b79"
		)
	]
)