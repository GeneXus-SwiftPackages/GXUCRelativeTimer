...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCRelativeTimer-3.1.0-rc.8.xcframework.zip",
			checksum: "df623f206c1825ed284f84c2dd55c6972fb419b1104faa297607cdf18f65a7c6"
		)
	]
)