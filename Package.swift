...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.5.0-beta.7.xcframework.zip",
			checksum: "7ad437d1f042bb7acecdaacddc97c62cb630f0869c51053485c571d03725044c"
		)
	]
)