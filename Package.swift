...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.5.0-beta.21.xcframework.zip",
			checksum: "ac69dee356b9de167014966a23f9a90bfd97264e873a03695f42cd7165137199"
		)
	]
)