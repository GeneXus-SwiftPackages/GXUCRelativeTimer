...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCRelativeTimer-4.0.6.xcframework.zip",
			checksum: "71a6fb8f7323f48fc5a87a4f1e6f631308f4057bf30d8b3fccdfa14018e97dff"
		)
	]
)