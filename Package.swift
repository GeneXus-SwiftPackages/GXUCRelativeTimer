...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCRelativeTimer-4.1.0.xcframework.zip",
			checksum: "db946986e45bb30886814dd60d428a1fa935fd978cfbf563d235f2e1cb0bd25f"
		)
	]
)