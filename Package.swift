...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.1.0-beta.8.xcframework.zip",
			checksum: "8aa5cce3db44854cd5cd60562b39f34ffb831cb10363b6d2fe9f221a8ea96919"
		)
	]
)