...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-3.2.0-beta.40.xcframework.zip",
			checksum: "a860d03926e012975b0d7212e8d3d0b7866d4e97460fd74bb57af7bfead6ae21"
		)
	]
)