...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-2.0.0-beta.34.xcframework.zip",
			checksum: "17a6f1160ca45a0c4ab09e6fecae957cf04b204e75a10b8ce30cb860f3fc19e5"
		)
	]
)