...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCRelativeTimer-1.1.0-rc.4.xcframework.zip",
			checksum: "1111d337ee1b58a071c9fd1b9b80493816d3554b75edea34290217e71bf02e52"
		)
	]
)