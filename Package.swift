...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCRelativeTimer-3.2.0-rc.0.xcframework.zip",
			checksum: "f674234a661ad76d007c0a2cb9cdbb3f0afb9ef211c29a9c1b5ce0a640ab336e"
		)
	]
)