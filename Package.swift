...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-4.0.0-beta.48.xcframework.zip",
			checksum: "178723426e3201e6ee57fe4f9cd543ec26f3ce1667bc1e94f88aa8186451fd63"
		)
	]
)