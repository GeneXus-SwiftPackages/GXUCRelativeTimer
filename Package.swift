...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-4.1.0-beta.18.xcframework.zip",
			checksum: "881d4d49b48509abc0d033cd2f9bf82a285a7b9bdd1f0d66769354dc67cfb4c5"
		)
	]
)