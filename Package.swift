...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCRelativeTimer-3.0.2.xcframework.zip",
			checksum: "b825189cdbacd1c16249fb079c9eac0c83b1909cc63e94429bc9fff8046e8ead"
		)
	]
)