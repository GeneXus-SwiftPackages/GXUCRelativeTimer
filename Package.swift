...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-3.2.0-beta.30.xcframework.zip",
			checksum: "b46bc23deb2978a07fc1e8fa4356f4c74c6f26e12a1e544414b39348b08c6f62"
		)
	]
)