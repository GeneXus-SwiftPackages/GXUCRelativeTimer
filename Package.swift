...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-3.1.0-beta.16.xcframework.zip",
			checksum: "d050454db4d409971868b9dd08d1ff4b9774cc907fb958905e3c6a77cde4b685"
		)
	]
)