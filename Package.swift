...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.6.0-beta.4.xcframework.zip",
			checksum: "d3d3d8c175d385b07e1d63c140aee4f142b134482ae6762211cecb3cda19f415"
		)
	]
)