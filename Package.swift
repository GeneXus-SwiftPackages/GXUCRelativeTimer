...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCRelativeTimer-4.1.0-rc.24.xcframework.zip",
			checksum: "0af377719b05352acd771e352418f870a7e11f23ab676494dc0d9bb914ccfe2a"
		)
	]
)