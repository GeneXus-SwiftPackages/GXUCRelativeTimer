...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.2.0-beta.25.xcframework.zip",
			checksum: "c171f51a0a2d5de4b8669844f21243008fd9dd9d2a08cf6cf30e1a2483f682b2"
		)
	]
)