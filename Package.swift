...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-3.2.0-beta.34.xcframework.zip",
			checksum: "0dacd51674af0649b166dac58b1a1bf3a5acb3eb5f8601ec6c63a07f426ecf66"
		)
	]
)