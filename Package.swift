...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-3.1.0-beta.32.xcframework.zip",
			checksum: "a038696af62e341fbdda376248c6fab76294d29e6a6cc6ee1e6fb3aa3c9e30bc"
		)
	]
)