...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-3.2.0-beta.27.xcframework.zip",
			checksum: "21e525ed10741215e46a8ed37159aa8b9525f0790756d6fa4d9075549b6fbe82"
		)
	]
)