...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.4.0-beta.17.xcframework.zip",
			checksum: "30ce6513468ed2222ea7ed1432c880759c903d4ff214f11b7ef8775165275907"
		)
	]
)