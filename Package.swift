...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.4.0-beta.13.xcframework.zip",
			checksum: "ae8814faeaa60c9cf716dd26e27cede0a44e08e47500bd75ed1f7eec62ad4bee"
		)
	]
)