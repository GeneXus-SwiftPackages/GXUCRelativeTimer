...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-4.1.0-beta.15.xcframework.zip",
			checksum: "7f5fecc57f7c4943512d2ca62ed65b11548efef4d8989a2fd454c458c15bc1de"
		)
	]
)