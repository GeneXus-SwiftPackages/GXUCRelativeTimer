...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-3.2.0-beta.20.xcframework.zip",
			checksum: "a3d2d80992adb9cd3d7d14f07f295e8b30edf650f1aaa6a8729ba35fae7873d1"
		)
	]
)