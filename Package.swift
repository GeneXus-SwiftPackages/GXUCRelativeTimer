...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCRelativeTimer-4.2.0-rc.20.xcframework.zip",
			checksum: "51eefaf054909a9cbcb7356be328f468ef78d992adcd69ae0a3bfa7a58a433e1"
		)
	]
)