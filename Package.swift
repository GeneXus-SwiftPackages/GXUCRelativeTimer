...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCRelativeTimer-3.2.0-rc.12.xcframework.zip",
			checksum: "c30b2b894455c1ffe563b7527215166f0447fa3e18cecfced7746621b7dd9016"
		)
	]
)