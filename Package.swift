...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-3.0.0-beta.17.xcframework.zip",
			checksum: "f13b18270c5fc017ec59ca745b3a46b2c8edff0871c35bc9707f5aa2692cb8fc"
		)
	]
)