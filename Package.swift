...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.5.0-beta.12.xcframework.zip",
			checksum: "ad3d5e9a6af656f79de19a019e74eae0faa04c5cff2e871f659a906f68c00603"
		)
	]
)