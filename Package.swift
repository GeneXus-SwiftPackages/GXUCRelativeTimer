...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCRelativeTimer-3.0.1.xcframework.zip",
			checksum: "29d0c02b4a7337e6d10eecf81de63033fcb2c5328d951b7660cadce54cadc47f"
		)
	]
)