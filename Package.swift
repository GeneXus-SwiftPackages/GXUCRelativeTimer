...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-2.0.0-beta.21.xcframework.zip",
			checksum: "35851d0e2476fef219415a351f1dd571901d3a6b16ea5ba9f5dc938fdf7ce9b7"
		)
	]
)