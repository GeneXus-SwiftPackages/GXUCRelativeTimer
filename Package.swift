...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-4.1.0-beta.7.xcframework.zip",
			checksum: "40ddf5c33c844edb79a4ce4eceeec90d747ecd17c29934a47d8b9921ac48c9f2"
		)
	]
)