...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.5.0-beta.25.xcframework.zip",
			checksum: "ce7824008dc3516a10ce2cbd5b5749f9b1b367e5bec411a650e77ae75f2950e4"
		)
	]
)