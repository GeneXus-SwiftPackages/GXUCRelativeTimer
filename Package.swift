...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.2.0-beta.21.xcframework.zip",
			checksum: "d38d9a1a9285dc93fb02fdc6f9c28df31370396ce5242ab1f60f54676ae5e09c"
		)
	]
)