...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.3.0-beta.7.xcframework.zip",
			checksum: "2434182620dea4a61cdde9267397f63ae8147d07cf8e64de70ceb6d9901f5b81"
		)
	]
)