...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCRelativeTimer-4.1.1.xcframework.zip",
			checksum: "83f61765459dc04918c44b6fda246d18c36d5f3cd70b4bc0f3f9a769ecda8659"
		)
	]
)