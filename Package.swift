...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCRelativeTimer-4.0.7.xcframework.zip",
			checksum: "b107a83aefc1b0348b7b4970eef09de697465a75e1dc737987d3fb09c95bb3a4"
		)
	]
)