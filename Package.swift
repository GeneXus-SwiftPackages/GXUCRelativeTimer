...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.6.0-beta.1.xcframework.zip",
			checksum: "a370896282d4c6e8d59d2befb12e2b0a0367d21caeca072d6251a11df9558402"
		)
	]
)