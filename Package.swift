...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-2.0.0-beta.16.xcframework.zip",
			checksum: "f471ca6ec36c3a4cf97804738b55d72baa998b59f07cc44d6a763526c05fe484"
		)
	]
)