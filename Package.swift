...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-2.0.0-beta.17.xcframework.zip",
			checksum: "4608259586088a16aed8706851f96d0f1eafffab488298734ac0c3c8eac91409"
		)
	]
)