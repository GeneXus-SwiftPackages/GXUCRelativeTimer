...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-3.1.0-beta.5.xcframework.zip",
			checksum: "cba1334286e2b973f7f8121fd05353b9db9d1fe250e6f99d8127520da855ef18"
		)
	]
)