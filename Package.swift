...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.2.0-beta.26.xcframework.zip",
			checksum: "541732b9072a6fe4812da70487c4e31a04cc8bfdebd3aadb26fb07e3e143d80a"
		)
	]
)