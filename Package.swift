...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-2.1.0-beta.23.xcframework.zip",
			checksum: "09629f3c0f36aa9d8f641de8026b2110629dc3132c9d84ce7d65209961bf5d8c"
		)
	]
)