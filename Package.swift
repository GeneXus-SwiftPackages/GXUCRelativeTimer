...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-3.1.0-beta.13.xcframework.zip",
			checksum: "d188af05955cdb1abf3800ed841538f933e8e0a9d542f3cf703651384f61778a"
		)
	]
)