...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.5.0-beta.26.xcframework.zip",
			checksum: "8b227477eeaaa5500d95edbf6e83ad873d96d5018cfaa0765b47471f4dff6d3f"
		)
	]
)