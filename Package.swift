...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCRelativeTimer-3.2.0-rc.11.xcframework.zip",
			checksum: "8dd41371cc75243d505cf65ad34215a32a861b7606a90b01c31bd5821790eec0"
		)
	]
)