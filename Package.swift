...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-2.2.0-beta.19.xcframework.zip",
			checksum: "dc035d0b7adb247de29d1df73923e440ee26d04bca7be40d2a803bb53065b9ec"
		)
	]
)