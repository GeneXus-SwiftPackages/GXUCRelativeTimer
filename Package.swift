...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-4.1.0-beta.9.xcframework.zip",
			checksum: "c022e9f3b7090251da5934885c7ee2f810cdb70e5fdf600ba3d0a3e3145c0153"
		)
	]
)