...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-3.1.0-beta.8.xcframework.zip",
			checksum: "74c48daa592b59422d0a59ac36f7c23d90528ebf7ad3e4f59f7e37b0ea4e1aa4"
		)
	]
)