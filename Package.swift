...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-3.2.0-beta.9.xcframework.zip",
			checksum: "b9790454a37889509c8638ffdcc73ca512f3f29f02727fa30cf302d54cecceb0"
		)
	]
)