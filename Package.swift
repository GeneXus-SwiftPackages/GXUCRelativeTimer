...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.5.0-beta.16.xcframework.zip",
			checksum: "2df7faba5dcdd197878d3db6b10c02ce699cc2ed3be39ae3910b64a2743e1b2a"
		)
	]
)