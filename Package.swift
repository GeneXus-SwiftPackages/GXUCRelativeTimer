...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCRelativeTimer-4.0.0-rc.0.xcframework.zip",
			checksum: "6c392cde0582547a5a67f0177a1e3ffcdaa7af97b43633378982e865f8423712"
		)
	]
)