...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-3.1.0-beta.31.xcframework.zip",
			checksum: "41f44d068436efa0b781a430d24b0d3783372272d2a33ccbbb44b86ad591869f"
		)
	]
)