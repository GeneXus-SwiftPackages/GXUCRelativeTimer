...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.5.0-beta.20.xcframework.zip",
			checksum: "e4391ed3343361d32327a25b73c469e97e4cd04fcbfa0d4451116babcf26eb7b"
		)
	]
)