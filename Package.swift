...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCRelativeTimer-1.4.26.xcframework.zip",
			checksum: "658f4fae957ecb6c82a382d4c67364f44f706713ca9945764350a767db5894d8"
		)
	]
)