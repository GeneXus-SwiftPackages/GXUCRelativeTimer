...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.3.0-beta.10.xcframework.zip",
			checksum: "31c929382eb8dba740f7c58eded860d15af8b9eb2e1d4521d35d47f0ac58f191"
		)
	]
)