...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.0.0-beta.20230726144822.xcframework.zip",
			checksum: "a8528a4dea0322c405cfc19ed0b4e7f1d2f46e8a3e169274953e6f982afa2a1f"
		)
	]
)