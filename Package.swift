...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.2.0-beta.22.xcframework.zip",
			checksum: "2af217d7581b0dc635770239e966e298f9ac45c4f40399c42440427256ad5d96"
		)
	]
)