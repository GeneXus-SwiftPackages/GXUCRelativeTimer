...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.2.0-beta.37.xcframework.zip",
			checksum: "00734bbf85736ac28a751f1f0980f3a62c5294d9a4314c7273fa10b7859d6b4b"
		)
	]
)