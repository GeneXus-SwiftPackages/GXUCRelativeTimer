...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCRelativeTimer-1.5.11.xcframework.zip",
			checksum: "477dbc636eb6c188d6a936ca96f330d54802be188c993617d45217cad70c4406"
		)
	]
)