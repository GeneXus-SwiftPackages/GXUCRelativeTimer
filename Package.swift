...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-4.2.0-beta.5.xcframework.zip",
			checksum: "e2fc5311a62397d9bbd1336e00e275e2509f930f65f1e168aed6a8508b2c9760"
		)
	]
)