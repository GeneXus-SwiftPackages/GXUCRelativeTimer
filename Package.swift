...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-2.2.0-beta.15.xcframework.zip",
			checksum: "c3e55da3b7746ab7b8005c7aa5c454645a14efe4a46e79a54251624db1fc166c"
		)
	]
)