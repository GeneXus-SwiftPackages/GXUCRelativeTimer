...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-2.0.0-beta.27.xcframework.zip",
			checksum: "5ac14302962d2d45fc9d96832342783c580e78adaedf43dee3c04061d06d6635"
		)
	]
)