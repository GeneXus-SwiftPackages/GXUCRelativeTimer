...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-3.0.0-beta.4.xcframework.zip",
			checksum: "ccaacd6183084420ee6a3c11bbee3f40e9133dccad39859777a0ac9cb47b9c3b"
		)
	]
)