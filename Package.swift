...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-3.1.0-beta.4.xcframework.zip",
			checksum: "2ed70e51afbaa175cc3d874635370cf011ae8ee37c21870711ddd78926a7c8e5"
		)
	]
)