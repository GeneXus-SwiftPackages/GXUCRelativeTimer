...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCRelativeTimer-2.0.17.xcframework.zip",
			checksum: "9b1ebb628407f3750a84de2396d5d36a19f1c162c44306e8a5b7124601cfe8b9"
		)
	]
)