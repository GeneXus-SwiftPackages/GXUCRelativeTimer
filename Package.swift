...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCRelativeTimer-4.1.0-rc.25.xcframework.zip",
			checksum: "003817bc819bafe17ccd5ddbaf1309f061aab8858d3cc98f0378e12c80faa74a"
		)
	]
)