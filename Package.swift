...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-4.1.0-beta.12.xcframework.zip",
			checksum: "70b4a145bf1b5606fd7fa7324f50dbc892008ab30f15c2064d51961180983271"
		)
	]
)