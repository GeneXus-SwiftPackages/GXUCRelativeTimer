...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-4.2.0-beta.11.xcframework.zip",
			checksum: "2c3fc5314ddb1d6d4e1041653dcfde2d64069cc9beee8648f141848b616d8147"
		)
	]
)