...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCRelativeTimer-1.2.0-rc.1.xcframework.zip",
			checksum: "5080543d6c4e41521b8fb0d9bce5091a238f064427ce6810da8b211e07ff6027"
		)
	]
)