...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-3.2.0-beta.32.xcframework.zip",
			checksum: "631676ef278aec5e9f6cfb09afc4c7c6451f375c1f1f6eecd15553477f432963"
		)
	]
)