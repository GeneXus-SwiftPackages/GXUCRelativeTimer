...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-3.1.0-beta.10.xcframework.zip",
			checksum: "1d57da040f8b698229707b70b976a9eff95fa8b6cdec0c1ca4b31cc007f5d269"
		)
	]
)