...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-4.2.0-beta.19.xcframework.zip",
			checksum: "187160b60dbee57aab528d6d70ec32c0af9574dbbda3272d3454b9caac4c5186"
		)
	]
)