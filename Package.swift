...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.3.0-beta.2.xcframework.zip",
			checksum: "abe9b81e4f93a61ed795a23f98fc606d633d5493a26f04a5dd8a8e5a2e50daa9"
		)
	]
)