...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.3.0-beta.3.xcframework.zip",
			checksum: "b9c4359ee934e0b7dfce81c095aa7c183d64a700c8823e1439d1a711adbd1d9d"
		)
	]
)