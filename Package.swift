...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCRelativeTimer-2.1.3.xcframework.zip",
			checksum: "d259e9c2193615d8f17dee80ff04d0a2d7c01a364a8858c39a112b8445163a20"
		)
	]
)