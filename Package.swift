...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.2.0-beta.36.xcframework.zip",
			checksum: "5b38f5a3e6eedf92aec0cc6780d2f478dcd6140eb07df7793958c9158a6fa6e5"
		)
	]
)