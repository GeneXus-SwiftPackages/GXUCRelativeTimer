...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-3.1.0-beta.26.xcframework.zip",
			checksum: "fa9e199dd3eca1f65a61b26505f1d41b01072517b76272017a5aab8c0587e5b9"
		)
	]
)