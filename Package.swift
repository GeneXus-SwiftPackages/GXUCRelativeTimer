...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.2.0-beta.11.xcframework.zip",
			checksum: "9ea97ab49c7d5a9d74073eabd51d4b7d769a34ee809126f9d7eb84e91b55d6f4"
		)
	]
)