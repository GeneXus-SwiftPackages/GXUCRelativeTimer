...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.2.0-beta.9.xcframework.zip",
			checksum: "317abbf3296acf201f6d97f77ce6eee82af0f185b61de8c6eaeccfc496305d3c"
		)
	]
)