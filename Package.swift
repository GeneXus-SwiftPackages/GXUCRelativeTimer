...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCRelativeTimer-3.0.4.xcframework.zip",
			checksum: "41d3426371f4a41c81cc1cc528e68be8cbce9c660488213f344d3f8d9f9ce1a9"
		)
	]
)