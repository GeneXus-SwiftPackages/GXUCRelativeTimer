...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-3.2.0-beta.36.xcframework.zip",
			checksum: "cdd811f6be61b7fe4942a2f58513e06b6dd8fef1e7a68701ce563879d4baa21a"
		)
	]
)