...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCRelativeTimer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCRelativeTimer-1.1.0-beta.9.xcframework.zip",
			checksum: "47a87ab32f4111c1208cca8c7df5340b6fa153c35a2d856cf50f86dfda82bf0f"
		)
	]
)